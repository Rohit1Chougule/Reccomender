...
#### Loading data
books = pd.read_csv(r'C:\Users\radha\P402 - BOOK RECOMMENDATION\Books.csv', encoding='latin-1', dtype={3: str}, low_memory=False)
users = pd.read_csv(r'C:\Users\radha\P402 - BOOK RECOMMENDATION\Users.csv', encoding='latin-1')
ratings = pd.read_csv(r'C:\Users\radha\P402 - BOOK RECOMMENDATION\Ratings.csv', encoding='latin-1')
